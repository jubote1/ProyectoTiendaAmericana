 ...
 */
@WebServlet("/DarLlegadaDomicilios")
public class DarLlegadaDomicilios extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DarLlegadaDomicilios() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
				...
				try
				{
					logger.info("En proceso de dar llegada para domiciliario  " + idUsuario);
					//Debemos de validar la existencia del usuario
					PedidoCtrl pedCtrl = new PedidoCtrl();
					respuesta = pedCtrl.darLlegadaDomicilios(idUsuario, usuario);
				}catch(Exception e)
				{
