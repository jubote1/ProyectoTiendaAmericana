 ...
 */
@WebServlet("/DevolverEstadoDomicilio")
public class DevolverEstadoDomicilio extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DevolverEstadoDomicilio() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
				...
				try
				{
					logger.info("En proceso para devolver estado de pedido para el usuario  " + idUsuario);
					//Debemos de validar la existencia del usuario
					PedidoCtrl pedCtrl = new PedidoCtrl();
					respuesta = pedCtrl.devolverEstadoDomicilio(idUsuario, usuario, JSONidPedido);
				}catch(Exception e)
				{
