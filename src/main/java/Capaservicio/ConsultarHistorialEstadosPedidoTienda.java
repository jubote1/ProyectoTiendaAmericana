 ...
 */
@WebServlet("/ConsultarHistorialEstadosPedidoTienda")
public class ConsultarHistorialEstadosPedidoTienda extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ConsultarHistorialEstadosPedidoTienda() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String respuesta = pedidoCtrl.consultarHistorialEstadosPedidoTienda(idPedidoTienda);
