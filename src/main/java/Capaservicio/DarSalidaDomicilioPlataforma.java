 ...
 */
@WebServlet("/DarSalidaDomicilioPlataforma")
public class DarSalidaDomicilioPlataforma extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DarSalidaDomicilioPlataforma() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
				...
				try
				{
					...
					respuesta = pedCtrl.darSalidaDomicilioPlataforma(idUsuario, usuario, idPedido);
				}catch(Exception e)
				{
