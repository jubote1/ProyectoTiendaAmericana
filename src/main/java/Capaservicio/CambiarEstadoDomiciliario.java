...
public class CambiarEstadoDomiciliario extends HttpServlet {
     ...
     */
    public CambiarEstadoDomiciliario() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
				...
				try
				{
					logger.info("En proceso de cambiar estado de domiciliario  " + idUsuario);
					//Debemos de validar la existencia del usuario
					PedidoCtrl pedCtrl = new PedidoCtrl();
					respuesta = pedCtrl.cambiarEstadoDomiciliario(idUsuario);
				}catch(Exception e)
				{
